        ...
        for sub_datastructure_yaml in yaml_content:
            ...
            for static in value_dict["statics"]:
                sub_datastructure.add_static(
                    static["static_name"], static["static_type"]
                )
